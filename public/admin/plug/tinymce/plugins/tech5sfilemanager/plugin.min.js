tinymce.PluginManager.add("teachfilemanager", function(e) {
    function n(t) {
        console.log(t);
        0 === e.settings.external_filemanager_path.toLowerCase().indexOf(t.origin.toLowerCase()) && "teachfilemanager" === t.data.sender && (tinymce.activeEditor.insertContent(t.data.html), tinymce.activeEditor.windowManager.close(), window.removeEventListener ? window.removeEventListener("message", n, !1) : window.detachEvent("onmessage", n))
    }
    ...
    e.addButton("teachfilemanager", {
        icon: "browse",
        tooltip: "Thêm tệp tin",
        shortcut: "Ctrl+E",
        onclick: t
    }), e.addShortcut("Ctrl+E", "", t), e.addMenuItem("teachfilemanager", {
        icon: "browse",
        text: "Thêm tệp tin",
        shortcut: "Ctrl+E",
        onclick: t,
