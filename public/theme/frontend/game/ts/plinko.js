...
/* harmony import */ var _PlinkoGlobal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PlinkoGlobal */ "./src/Plinko/PlinkoGlobal.ts");
/* harmony import */ var _PlinkoStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PlinkoStorage */ "./src/Plinko/PlinkoStorage.ts");
...
var PlinkoGameTimer = /** @class */ (function () {
    ...
    PlinkoGameTimer.prototype.countDownPlayBox = function (status) {
        if (!status) {
            _Base_Selector__WEBPACK_IMPORTED_MODULE_0__["default"].none(_Base_Selector__WEBPACK_IMPORTED_MODULE_0__["default"]._(".ready"));
        }
        else {
            var seconds = this.timeRemaining % 60 | 0;
            seconds = seconds < 10 ? "0" + seconds : String(seconds);
            _Base_Selector__WEBPACK_IMPORTED_MODULE_0__["default"].flex(_Base_Selector__WEBPACK_IMPORTED_MODULE_0__["default"]._(".ready"));
            var time = _Base_Selector__WEBPACK_IMPORTED_MODULE_0__["default"]._(".ready .time");
    ...
    PlinkoGameTimer.prototype.showTimePlayBox = function () {
        var lastPoint = parseInt(PLINKO_CONFIG.LAST_POINT_TO_BET);
        var status = _PlinkoStorage__WEBPACK_IMPORTED_MODULE_2__["default"].isGameBetted() || this.timeRemaining < lastPoint;
...
/* harmony import */ var _Plinko_PlinkoGameTimer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Plinko/PlinkoGameTimer */ "./src/Plinko/PlinkoGameTimer.ts");
...
/* harmony import */ var _Plinko_PlinkoUi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Plinko/PlinkoUi */ "./src/Plinko/PlinkoUi.ts");




var socket = new _Base_Socket__WEBPACK_IMPORTED_MODULE_0__["default"]('ws://localhost:8888/');
var plinkoSocket = new _Plinko_PlinkoSocket__WEBPACK_IMPORTED_MODULE_2__["default"](socket);
var plinkoGameTimer = new _Plinko_PlinkoGameTimer__WEBPACK_IMPORTED_MODULE_1__["default"](plinkoSocket);
var plinkoUi = new _Plinko_PlinkoUi__WEBPACK_IMPORTED_MODULE_3__["default"](plinkoSocket);
