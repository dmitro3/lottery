...
<div id="app">
    <div class="mian">
        <div class="navbar">
            ...
            <div class="navbar-title">Lịch sử nhận</div>
            <div class="navbar-right">
                <a href="tai-khoan/marketing/lich-su-gioi-thieu{{Support::renderBackLinkParamater('tai-khoan/marketing/lich-su-nhan')}}" class="c-row">
                    <i class="van-icon van-icon-notes-o" style="font-size: 25px;color: #ffffff"></i>
                </a>
            </div>
        </div>
        <div class="promotion">
            @include('auth.marketing.action_tab',['activeTab'=>'lich-su-nhan'])
            <div class="tit c-row c-row-between">Lịch sử hoa hồng</div>
            <div class="list">
                        ...
                        @foreach ($listItems as $item)
                            <div class="item c-row c-row-between">
                                <div class="c-row">
                                    ...
                                    <div class="m-l-10">
                                        <div class="tit" style="padding: 0;height: auto;background: none;line-height: inherit">{{Support::show($item->walletTransactionType,'short_name')}}</div>
