...
<form class="form-validate" action="tai-khoan/send-recharge" method="post" accept-charset="utf8" absolute data-success="RECHARGE_GUI.sendRechargeDone">
    ...
    @if ($rechargeMethod->id == RechargeMethod::ONLINE_MOMO_PRINCE_PAY)
        <div class="list m-t-10 c-row c-row-between c-flex-warp">
            ...
            <div class="li amount-selecter" data-amout="1500000"><span class="number">1.5M</span></div>
            <div class="li amount-selecter" data-amout="2000000"><span class="number">2M</span></div>
    ...
    <div class="btn-list c-row c-row-center m-t-30">
        <div class="item flex-cover">
            <button class="next-btn van-button van-button--default van-button--normal  van-button--block van-button--round" style="color: rgb(255, 255, 255); background: rgb(92, 186, 71); border-color: rgb(92, 186, 71);">
