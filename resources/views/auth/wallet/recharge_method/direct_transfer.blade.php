<form class="form-validate" action="tai-khoan/send-direct-transfer-recharge" method="post" accept-charset="utf8" absolute data-success="RECHARGE_GUI.directTransferDone">
    @csrf
