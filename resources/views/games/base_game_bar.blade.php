...
<div class="game-head">
    <div class="total-box">
        <div class="c-row c-row-between c-row-middle info">
            ...
            <div class="c-row c-row-middle">
                <div class="num">
                    <span class="user-money-preview"> {{number_format((int)$user->getAmount(),0,',','.')}} đ</span>
                </div>
                <div class="van-image image-reload-money-user img m-l-10" style="width: 15px; height: 15px;" onclick="BASE_GUI.reloadUserMoney(this)">
